...
<body class="grey-bg">
<input type="hidden" class="form-control" readonly="readonly" value="${service.serviceId}" id="serviceId">
					...
					<div class="ibox-content">
                        <form method="get" class="form-horizontal"  id="signupForm">
	                      <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" value="${service.serviceNo}" class=" form-control" placeholder="" id="companyName" readonly="readonly"> 
                                </div>
                                </div> 
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-7">
	                                    <input type="text" value="${etopservice.category}" class=" form-control" placeholder="" id="category" readonly="readonly"> 
	                                </div>
	                             </div>
	                             ...
	                             <div class="form-group">  
	                                ...
	                                <div class="col-sm-7">
	                                    <input type="text" value="${etopservice.subject}" class=" form-control" placeholder="" id="subject" readonly="readonly"> 
	                                </div>
	                             </div>
	                            ...
	                            <div class="form-group">  
	                             ...
	                             <div class="form-group">     
									...
									<div class="col-sm-7">
										<input type="text" class="form-control"  value="${etopservice.finalPrice}" id="finalPrice" name="finalPrice">
									</div>
								</div> 
