                                    ...
                                    <div class="ibox float-e-margins">
                                        <form method="get" class="form-horizontal" id="courseForm">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-sm-2">
<!--                                                     <input type="text" class="form-control" id="offlineType" name="offlineType" value="计划外课程" readonly="readonly"> -->
                                                    <select class="form-control m-b" id="offlineType" name="offlineType">
                                                            <option value="0">线下课程</option>
                                                            <option value="1">计划内培训</option>
                                                            <option value="4">计划外培训</option>
                                                        </select>
                                                </div>
...
<%--                                                     <div class="col-sm-2" style=" padding-top: 18px;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <img id="coverImg" alt="" src="" height="100px" width="100px">
                                                    </div>
                                                </div>
	...
	function ajaxFileUpload2() {
		 upload('<%=basePath%>/parkgroup/uploadImg.do?id=${id}',"file2",function(data){
