                    ...
                    <form method="get" class="form-horizontal" id="checkForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="hidden" class=" form-control" placeholder="" id="photo">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="" cols="" class="form-control" placeholder="" name="profile" id="profile"></textarea>
                                </div>
...
<script type="text/javascript">
    ...
    function ajaxFileUpload() {
        ...
        /*$.ajaxFileUpload({
            url : '<%=basePath%>/etopTrainTeacher/uploadImg.do?courseId=${courseId}',
            secureuri : false,
            ...
            success : function(data, status) {
                if(data.status==10001){
                    $("#fileImg").attr('src','<%=ImgProperties.LOAD_PATH%>'+data.data.path);
                    $("#photo").val(data.data.path);
                    $("#fileImg").show();
                    swal({
                        title: "上传成功!",
