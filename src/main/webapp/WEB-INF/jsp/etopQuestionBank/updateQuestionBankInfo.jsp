					...
					<form method="get" class="form-horizontal" id="signupForm">
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" value="${questionBank.title}" id="title">
								</div>
								...
								<div class="col-sm-2">
									<select class="form-control m-b" id="correctAnswer" name="correctAnswer" style="float: left; margin-right: 1%;">
										<option value="A"
												<c:if test="${questionBank.correctAnswer == 'A'}">selected</c:if> >A
										</option>
										<option value="B"
												<c:if test="${questionBank.correctAnswer == 'B'}">selected</c:if> >B
										</option>
										<option value="C"
												<c:if test="${questionBank.correctAnswer == 'C'}">selected</c:if> >C
										</option>
										<option value="D"
												<c:if test="${questionBank.correctAnswer == 'D'}">selected</c:if> >D
										</option>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" value="${questionBank.answerA}" id="answerA">
								</div>
								<label class="col-sm-1 control-label">B<font color="red">*</font></label>
								<div class="col-sm-3">
									<input type="text" class="form-control" value="${questionBank.answerB}" id="answerB">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" value="${questionBank.answerC}" id="answerC">
								</div>
								<label class="col-sm-1 control-label">D<font color="red">*</font></label>
								<div class="col-sm-3">
									<input type="text" class="form-control" value="${questionBank.answerD}" id="answerD">
								</div>
							</div>
...
<script type="text/javascript">
	...
	function submitQuestionBank(){
		...
		$.post("updateEtopQuestionBankInfo.do",params,function(data){
