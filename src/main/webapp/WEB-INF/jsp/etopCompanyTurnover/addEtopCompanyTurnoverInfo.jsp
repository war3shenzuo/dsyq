                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form_datetime form-control" id="yearsDate" name="yearsDate">
                                    </div>
                                </div>

                                <label class="col-sm-1 control-label">营业额<font color="red">*</font></label>
                                <div class="col-sm-2">
                                    <input type="number" class="form-control" id="turnover" name="turnover" aria-required="true">
                                </div>
...
<script type="text/javascript">
    ...
    function submit() {
        ...
        $.post("addEtopCompanyTurnoverInfo.do", params, function (data) {
