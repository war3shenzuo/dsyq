...
<input type="hidden" value="${defaultParkId }" id="parkId">
<body class="gray-bg">
					                    ...
					                    <div class="col-sm-12">
					                        ...
					                        <div class="example-wrap">
					                                ...
					                                <!-- <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
										               ...
										               data-toggle="table"
										               data-url="<%=basePath%>/etopService/getServiceBycompanyId.do?parkId=${defaultParkId}"
										               data-data-type="json"
...
<!-- 											                <th data-field="serviceTypeName" data-align="center">服务类型</th> -->
    ...
    <script type="text/javascript">
    	...
    	function search(){
    		tableRefresh('<%=basePath%>/etopService/getServiceBycompanyId.do?parkId='+$("#parkId").val());
    	}
        ...
        function formatterFunService(value,row,index){
			...
			var refreshUrl = '<%=basePath%>/etopService/getServiceBycompanyId.do?parkId='+$("#parkId").val();
