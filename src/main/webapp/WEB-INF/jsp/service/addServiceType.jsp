                           ...
                           <div class="row">
                            ...
                            <div class="col-sm-12">
                          	<div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class=" form-control" placeholder="名称首字母大写" name="serviceCode" id="serviceCode"> 
                                </div>
                                <label class="col-sm-1 control-label">服务名称<font color="red">*</font></label>
                                <div class="col-sm-5">
                                    <input type="text" class=" form-control" placeholder="" name="serviceName" id="serviceName"> 
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <textarea rows="5" cols=""class=" form-control" placeholder="" name="descript" id="descript"></textarea>
                                </div>
                           
                                <label class="col-sm-1 control-label">条款<font color="red">*</font></label>
                                <div class="col-sm-5">
                                	<textarea rows="5" cols=""class=" form-control" placeholder="" name="item" id="item"></textarea>
                                </div>
                            </div>
                            </div>
                            </div>
