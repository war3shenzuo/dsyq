...
var quotationId = $("#quotationId").val();
	...
	function submit() {
		...
		$.post('<%=basePath%>/quotation/addQuotationService.do',param,function(data){
	...
	function searchCategory() {
		$.get('../quotation/getServiceQuotationGroup.do', {
        ...
        $.ajax({  
               type: "POST",      
                url: "<%=basePath%>/quotation/proveQuotationName.do",      
                 data: {quotationName: $("#quotationName").val(), type:"repair"}, 
