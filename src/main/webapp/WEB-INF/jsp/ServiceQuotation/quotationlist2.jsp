			...
			<div class="row row-lg">
				...
				<div class="col-sm-2">
					...
					<div class="row">
                        ...
                        <div class="col-sm-2">
                            <label>类别</label>
                            <input type="text" class="form-control m-b" placeholder="" id="category">
                        </div>
                        <div class="col-sm-2">
                            <label>维修类型</label>
						...
						<div class="col-md-2">
                        	<button class="btn btn-primary" onclick="tableRefresh('getServiceQuotation.do')" type="button" style="margin-top: 23px;;">搜索</button>
                        </div>
					...
					<div class="example-wrap">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <a class="btn btn-outline btn-default" 
                                        onclick="openAddPage('新增维修项目','50%','70%','<%=basePath %>/quotation/addPage.do','<%=basePath%>/quotation/getServiceQuotation.do')" >
						...
						<table id="quotationListTable"
				               ...
				               data-toggle="table"
				               data-url="getServiceQuotation.do"
				               data-data-type="json"
							...
							<thead>
                                ...
                                <th data-field="quotationName" data-align="center">维修服务名称</th>
...
var table = $('#quotationListTable');
	...
	function queryParams(params){
   	...
   	function detailButtonFormatter(value, row, index) {
       		...
       		url = "quotation/getQuotationInfoById.do?quotationId=" + value;
    ...
    function formatterFun(value,row,index){
		...
		var refreshUrl = '<%=basePath%>/quotation/getServiceQuotation.do';
...
/* 	       +'&nbsp;&nbsp; ' +
                ...
                $.get("<%=basePath%>/quotation/deleteQuotation.do?quotationId="+quotationId, {
                    ...
                    if (data.status == 10001) {
                        swal({
                            ...
                            tableRefresh('getServiceQuotation.do');
                        });
                    } else {
                        swal({
                            title: data.msg,
    ...
    $(document).ready(function () {
    	parktree = $("#parktree").jstree({
        	...
        	$("#parkId").val(id);
    		tableRefresh(basePath+'/quotation/getServiceQuotation.do?parkId='+id);
