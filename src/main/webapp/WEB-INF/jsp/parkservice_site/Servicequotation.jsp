...
<!-- 				    维修信息 -->
	                ...
	                <tr>
    					...
    					<td><e style=" display:block; border-bottom: 1px solid rgb(161,161,161); width:100%;line-height:26px; color:#666">维修信息</e></td>
    				...
    				<tr>
					    ...
					    <select id="subject" style="width: 249px;height: 34px; margin:0 32px 0 18px; text-indent: 10px;" class="form-control" onchange="gradeChange()">	</select>
					    </td>
    				</tr>
    				<tr>
...
function binding(){
    ...
    $.post("<%=basePath %>/quotation/getQuotationList.do", params, function(data){
...
// 	var subject = $("#subject").val();
	...
	$.post('<%=basePath%>/webparkservice/addServer.do?service_type=WYBX',param,function(data){
