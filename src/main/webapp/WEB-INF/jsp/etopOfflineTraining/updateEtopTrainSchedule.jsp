                    ...
                    <form method="get" class="form-horizontal" id="checkForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" placeholder="" id="title" name="title" value="${info.title}">
                                </div>

                                <label class="col-sm-1 control-label">主讲人<font color="red">*</font></label>

                                <div class="col-sm-2">
                                    <input type="text" class="form-control" placeholder="" id="teacher" name="teacher" value="${info.teacher}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form_datetime form-control" id="startDate" name="startDate"
                                               value='<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${info.startDate}"/>'>
                                    </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form_datetime form-control" id="endDate" name="endDate" value='<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${info.endDate}"/>'>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="" cols="" class="form-control" placeholder="" name="content" id="content">${info.content}</textarea>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="" cols="" class="form-control" placeholder="" name="remark" id="remark">${info.remark}</textarea>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function submit() {
        ...
        $.post("updateTrainSchedule.do", params, function (data) {
