...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="ibox float-e-margins">
		<h4 class="text-warning">提示：减免申请，请到账单详情页添加</h4>
				...
				<div class="col-sm-12">
					<div class="example-wrap">
						...
						<table id="reliefListTable"
							...
							<thead>
								<tr>
									<th data-field="reliefId">申请号</th>
									<th data-field="billId">账单号</th>
									<th data-field="companyName">客户</th>
									<th data-field="amount">本金</th>
									<th data-field="amountRelieved">本金已减免</th>
									<th data-field="amountRemission">本金申请减免</th>
									<th data-field="overdueFine">滞纳金</th>
									<th data-field="overdueRelieved">滞纳金已减免</th>
									<th data-field="overdueRemission">滞纳金申请减免</th>
...
<script type="text/javascript" src="<%=basePath %>/myjs/bill.relief.audit.js"></script>
</body>
</html>