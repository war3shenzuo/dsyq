			...
			<div class="row row-lg">
				...
				<div class="col-sm-2">
					...
					<div class="row">
						...
						<div class="col-md-2">
                        	<button class="btn btn-primary" onclick="tableRefresh('getBusinessService.do'),tableRefresh2('<%=basePath%>/etopService/calculateBusiness.do')" type="button" style="margin-top: 23px;;">搜索</button>
                        </div>
					</div>
				</div>
				<div class="ibox-content">
              <%--   <div class="row row-lg">
                    <div class="col-sm-4">
                        ...
                        <div class="example-wrap">
					               ...
					               data-toggle="table"
					               data-url="<%=basePath%>/etopService/calculateBusiness.do"
					               data-data-type="json"
					              ...
					              >
						            <thead>
						            <tr>
<!-- 						                <th data-field="subject" data-align="center" style="display: none;visibility: 0">服务名称</th> -->
				...
				<div class="col-sm-12">
					<div class="example-wrap">
						...
						<table id="businessListTable"
                           	   data-mobile-responsive="true"
				               data-toggle="table"
				               data-url="getBusinessService.do"
				               data-data-type="json"
				               data-side-pagination="server"
...
// 		 params.completeTime = $("#completeTime").val();
   	...
   	function detailButtonFormatter(value, row, index) {
       		...
       		var refreshUrl = '<%=basePath%>/business/getBusinessService.do';
       		var showInfo = "openAddPage('商务项目修改','70%','90%','"+infoUrl+"','"+refreshUrl+"')";
   	...
   	function updateStatus(id,status){
   		...
   		$.post("<%=basePath%>/etopService/updateStatus.do",param,function(data){
   			if(data.status==10001){
   				swal( "操作成功！", "","success");
   				tableRefresh('getBusinessService.do');
   		    }else{
   		    	swal( "操作失败！", "","error");
   		    }
    ...
    $(document).ready(function () {
    	parktree = $("#parktree").jstree({
        	...
        	$("#parkId").val(id);
    		tableRefresh(basePath+'/business/getBusinessService.do?parkId='+id);
