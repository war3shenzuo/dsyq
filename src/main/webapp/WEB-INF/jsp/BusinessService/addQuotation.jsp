...
var quotationId = $("#quotationId").val();
	...
	function submit() {
		...
		$.post('<%=basePath%>/business/addBusinessService.do',param,function(data){
	...
	function searchCategory() {
		$.get('../business/makeBusinessServiceGroup.do', {
...
//              data: "quotationName="+quotationName, 
                data: {quotationName: $("#quotationName").val(), type:"service"}, 
