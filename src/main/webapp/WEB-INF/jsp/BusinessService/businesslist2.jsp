			...
			<div class="row row-lg">
				...
				<div class="col-sm-2">
					...
					<div class="row">
						...
						<div class="col-md-2">
                        	<button class="btn btn-primary" onclick="tableRefresh('makeBusinessService.do')" type="button" style="margin-top: 23px;;">搜索</button>
                        </div>
					</div>
					...
					<div class="example-wrap">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <a class="btn btn-outline btn-default" 
                                        onclick="openAddPage('新增维修项目','50%','70%','<%=basePath %>/business/addPage.do','<%=basePath%>/business/makeBusinessService.do')" >
						...
						<table id="quotationListTable"
				               ...
				               data-toggle="table"
				               data-url="makeBusinessService.do"
				               data-data-type="json"
							...
							<thead>
                                ...
                                <th data-field="quotationName" data-align="center">商务服务名称</th>
...
var table = $('#quotationListTable');
    ...
    function formatterFun(value,row,index){
		...
		var refreshUrl = '<%=basePath%>/business/makeBusinessService.do';
...
/* 	       +'&nbsp;&nbsp; ' +
                ...
                $.get("<%=basePath%>/quotation/deleteQuotation.do?quotationId="+quotationId, {
                    ...
                    if (data.status == 10001) {
                        swal({
                            ...
                            tableRefresh('makeBusinessService.do');
                        });
                    } else {
                        swal({
                            title: data.msg,
    ...
    $(document).ready(function () {
    	parktree = $("#parktree").jstree({
        	...
        	$("#parkId").val(id);
    		tableRefresh(basePath+'/business/makeBusinessService.do?parkId='+id);
