...
<!--                             <div class="form-group">
                                <label class="col-sm-3 control-label">类别<font color="red">*</font></label>
                                <div class="col-sm-7">
                                <input type="text" class="form-control" placeholder="" name="facilityType" id="facilityType"> 
                                </div>
                            </div> -->
                           ...
                           <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" style="width:400px"  placeholder="" name="facilityName" id="facilityName" > 
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control"  style="width:400px" placeholder="" name="facilityPrice" id="facilityPrice"> 
                                </div>
 ...
 <!--                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-7  clockpicker">
                                    <input type="text" class="form-control"  style="width:400px" placeholder="" name="startTime" id="startTime"> 
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7  clockpicker">
                                    <input type="text" class="form-control"  style="width:400px" placeholder="" name="endTime" id="endTime"> 
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">开放起始时间<font color="red">*</font></label>
                                <div class="col-sm-7">
                                   <input type="text" class="form-control timeRange"  style="width:400px" placeholder="" name="startTime" id="startTime"/>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">开放结束时间<font color="red">*</font></label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control  timeRange"  style="width:400px" placeholder="" name="endTime" id="endTime"> 
                                </div> 
	...
	function searchCategory() {
		$.get('../facility/getEtopFacilityListGroup.do', {
			'facilityType' : $('#categoryText').val()
		}, function(data) {
			var rows = data.rows;
			...
			for (var i = 0; i < rows.length; i++) {
				var oOption = document.createElement('option');
				oOption.text = rows[i].facilityType;
	...
	function prove(){  
        ...
        $.ajax({  
               type: "POST",      
                url: "<%=basePath%>/facility/provefacilityName.do",      
