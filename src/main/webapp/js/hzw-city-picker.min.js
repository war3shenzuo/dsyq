...
var HzwCityPicker = function(a) {
	this.template = $('<div class="hzw-city-picker" id="hzw_city_picker"><div class="hzw-hot-wrap"><p>热门城市</p><ul id="hzw_hot_city"></ul></div><div class="line"></div><div class="hzw-wrap"><p>选择城市</p><ul class="hzw-province-wrap" id="hzw_province_wrap"></ul></div></div>');
...
/*	addProvinceEvent: function() {
	...
	addProvinceEvent: function() {
		...
		g.province_wrap.on('click', '.hzw-province',
		function() {
			var a = $(this);
			var b = a.data('id');
			var c = a.data('name');
