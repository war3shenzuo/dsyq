...
function newTable2(herf,txt,herf2) {
	var o = herf,
	tt=herf2,
	m = $(this).data("index"),
	l = txt,
	...
	if (k) {
		...
		var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height="100%" src="' + o + '?herf2='+tt+'" frameborder="0" data-id="' + o + '" seamless></iframe>';
...
function tabclosed(herf,txt,title) {
	var m = herf;
	var tt=title;
	var mm=herf+"?herf2="+title;
