...
public class Criteria{
	 ...
	 * 存放排除的条件查 
	 */
	private Map<String, Object> nocondition;
	
	/**
	 * 自定义查询Sql
	 */
	private String myDefinedSql;
	...
	public Criteria() {
		...
		nocondition = new HashMap<String, Object>();
	}
	...
	public Criteria putNo(String condition, Object value) {
		this.nocondition.put(condition, value);
		return (Criteria) this;
	}
	...
	public Map<String, Object> getNocondition() {
		return nocondition;
	}

	public void setNocondition(Map<String, Object> nocondition) {
	...
	public String getMyDefinedSql() {
		return myDefinedSql;
	}

	public void setMyDefinedSql(String myDefinedSql) {
		this.myDefinedSql = myDefinedSql;
	}
