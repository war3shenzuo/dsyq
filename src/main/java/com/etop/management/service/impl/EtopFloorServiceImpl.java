 ...
 */
@Service("etopFloorService")
public class  EtopFloorServiceImpl  implements EtopFloorService {
	@Resource
	...
	@Override
	public List<EtopFloor> getFloorList(EtopFloor floor) {
	...
	@Override
	public void addFloor(EtopFloor floor) {
		
		floor.setId(UUID.randomUUID().toString());
		
		floor.setEnergyLastBillDate(new Date());
		
		floor.setCreatedAt(new Date() );
		
		etopFloorDao.add(floor);
